...
<body>
    ...
    <div class="container mt-5">
        <form method="post" action="<?= base_url('Tambah/save'); ?>">
            <?= csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="exampleInputTanggal1" name="tanggal_lahir">
            </div>
            <div class="form-group">
                <label for="exampleInputGaji1">Gaji</label>
                <input type="text" class="form-control" id="exampleInputGaji1" name="gaji">
            </div>
            <label for="exampleRadios2">Status</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" id="exampleRadios2" value="1" name="status">
